"use client"; // Dodajemy, aby obsłużyć reset scrolla przy ładowaniu
...
export default function Home() {
  ...
  // Wymuszamy przewinięcie do góry przy każdym załadowaniu strony
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    ...
    <main className="fixed inset-0 z-[9999] bg-white flex flex-col items-center justify-start p-6 font-sans overflow-y-auto">
      ...
      <footer className="mt-8 mb-12 text-slate-400 text-[10px] font-bold uppercase tracking-[0.3em]">
        © {new Date().getFullYear()} Novamedic dr Jarosław Biłas
      </footer>
    </main>
  );
}